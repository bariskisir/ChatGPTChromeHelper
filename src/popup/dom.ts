...
export function getElements(): PopupElements {
  return {
    ...
    historyInput: getElement('historyInput'),
    ...
    addManualButton: getElement('addManualButton'),
    cancelManualButton: getElement('cancelManualButton'),
    ...
    manualInputText: getElement('manualInputText'),
    manualActionRow: getElement('manualActionRow'),
    manualActionSendButton: getElement('manualActionSendButton'),
    textScanButtonWrap: getElement('textScanButtonWrap'),
    imageScanButtonWrap: getElement('imageScanButtonWrap'),
